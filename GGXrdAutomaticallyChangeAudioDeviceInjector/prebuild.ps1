$content = Get-Content "GGXrdAutomaticallyChangeAudioDeviceInjector.rc"
$newline = "`
"
$tab = "	";
...
if ($need_write) {
	Set-Content -Value ($content_lines -join $newline) "GGXrdAutomaticallyChangeAudioDeviceInjector.rc" -Encoding Unicode
}
