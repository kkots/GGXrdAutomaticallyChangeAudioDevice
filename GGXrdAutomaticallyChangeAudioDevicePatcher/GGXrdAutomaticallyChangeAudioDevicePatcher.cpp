#include "pch.h"
#include "GGXrdAutomaticallyChangeAudioDevicePatcher.h"
...
UINT windowClassNameResourceId = IDC_GGXRDAUTOMATICALLYCHANGEAUDIODEVICEPATCHER;
LPCWSTR windowIconId = MAKEINTRESOURCEW(IDI_GGXRDAUTOMATICALLYCHANGEAUDIODEVICEPATCHER);
LPCWSTR windowMenuName = MAKEINTRESOURCEW(IDC_GGXRDAUTOMATICALLYCHANGEAUDIODEVICEPATCHER);
LPCWSTR windowAcceleratorId = MAKEINTRESOURCEW(IDC_GGXRDAUTOMATICALLYCHANGEAUDIODEVICEPATCHER);
