$content = Get-Content "GGXrdAutomaticallyChangeAudioDevicePatcher.rc"
$newline = "`
"
$tab = "	";
...
if ($need_write) {
	Set-Content -Value ($content_lines -join $newline) "GGXrdAutomaticallyChangeAudioDevicePatcher.rc" -Encoding Unicode
}
